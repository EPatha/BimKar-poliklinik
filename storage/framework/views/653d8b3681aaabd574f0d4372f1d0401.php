...
<body>
    ...
    <div class="container hero-poliklinik text-center">
        <img src="<?php echo e(asset('Logo_udinus.jpg')); ?>" alt="Logo UDINUS" class="logo-udinus mx-auto d-block">
        ...
        <div class="mb-4">
            <a href="<?php echo e(route('login')); ?>" class="btn btn-success cta-btn me-2">Login</a>
            <a href="<?php echo e(route('register')); ?>" class="btn btn-outline-success cta-btn">Register</a>
        </div>
